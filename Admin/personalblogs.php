...
<head>
    ...
    <link rel="stylesheet" href="../CSS/personalblog.css">
    ...
    <div>
        <?Php
            if (isset($_GET['id'])) {
                ...
                if ($r) {
                    header("Location: blogscount.php");
                }
            }
            ?>
    </div>
    <div class="back">
        <div class="nav">
            ...
            <ul>
                ...
                <li><a href="../Admin/blogscount.php"><b>Back</b></a></li>
        ...
        <div class="blogs">
            ...
            <table class="bloglist">
                ...
                $email = $_GET['Email'];
                $c = 1;
                $sq3 = "SELECT * from usersblog WHERE Email='$email'";
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="personalblogs.php?id=<?php echo $row2['id']; ?>" id="delbtn">Delete</a></td>
                    </tr>
                <?php } ?>
            </table>
        </div>
